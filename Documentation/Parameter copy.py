...
Pmec, speed, Vdc, Nm, Np = 60e3, 2.5e3, 380, 12, 10

# Assumptions
Vinv, m, alphaPM, Bs0, RotorSleeve = 2.31, 3, 0.83, 2, 1.5

kw, Hs0, Hs4, Rs, Kfill, Ks = 0.933, 1.5, 1.5, 0, 0.5, 0.95
...
Nph = fs(TurnsFinding, [200])

Ncoilside = m*Nph*2/Nm/2
